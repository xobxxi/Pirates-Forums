...
// XFCP stands for XenForo Class Proxy - it is a container that makes sure everything works together properly
	...
	public function actionYo()
	{
		...
		return $this->responseView(
			'PiratesNewsFeed__ViewPublic_Forum_Yo', // This is a fictional class, don't worry about why I guess lol
			'PiratesNewsFeed_news_template', /* This is a template created in the ACP and attached to this addon (As noted in the listener,

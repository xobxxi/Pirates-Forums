...
!function($, window, document, _undefined)
{
	XenForo.setupSkills = function() {
		...
		$('.pirateCard div.pirateHandle').hover(
			function() { $(this).css('background-image', 'url(\'http://piratesoffline.org/styles/pirates/card/handle/handle_over.png\')')},
		    function() { $(this).css('background-image', 'url(\'http://piratesoffline.org/styles/pirates/card/handle/handle.png\')')});
		...
		$('.pirateCard .pirateSkills li div.pirateProgressBar')
			...
			.css('border-image', 'url(http://piratesoffline.org/styles/pirates/card/borders/skills-border.png) 0 6 stretch')
			.css('-moz-border-image', 'url(http://piratesoffline.org/styles/pirates/card/borders/skills-border.png) 0 6 stretch')
